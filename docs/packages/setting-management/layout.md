...
- [useSettingManagement Hook](/docs/packages/setting-management/hook) - Programmatic tab management
- [SettingTab Model](/docs/packages/theme-shared/release-notes) - Tab interface from theme-shared
