...
- [Setting Layout](/docs/packages/setting-management/layout) - Using the layout component
- [useSettingManagement Hook](/docs/packages/setting-management/hook) - Managing tabs programmatically
