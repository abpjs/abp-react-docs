...
```bash
npm update @abpjs/core @abpjs/account @abpjs/account-pro @abpjs/feature-management @abpjs/identity @abpjs/permission-management @abpjs/setting-management @abpjs/tenant-management @abpjs/theme-basic @abpjs/theme-shared
```
