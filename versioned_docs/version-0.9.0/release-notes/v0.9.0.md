...
See [@abpjs/setting-management documentation](../packages/setting-management/overview.md) for full details.
...
| @abpjs/setting-management | 0.9.0 (new) |
| @abpjs/tenant-management | 0.9.0 |
...
```bash
npm update @abpjs/core @abpjs/account @abpjs/identity @abpjs/permission-management @abpjs/setting-management @abpjs/tenant-management @abpjs/theme-basic @abpjs/theme-shared
```
